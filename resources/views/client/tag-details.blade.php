...
@section('title')
    Informasi Tips dan Kesehatan Seputar {{ $tag->name }} | Pintar Pet
@endsection

@section('content')
    <div class="container">
        @include('__partials.tagBreadcrumbs')
        ...
        <div class="category__banner">
            <div class="category__banner-image">
                <img src="https://ik.imagekit.io/z0he7w4iilk/tr:w-200,h-200/assets/img/pintarpet-mascot-full_DcnIRKTh30.png"
                    alt="Artikel Terbaru Seputar {{ $tag->name }}">
            </div>
            <div class="category__banner-content">
                <div class="category__banner-title">
                    <span>
                        Artikel Terbaru Seputar {{ $tag->name }}
                    </span>
                </div>
                <div class="category__banner-description">
                    <span>
                        Sumber infomasi terbaru seputar {{ $tag->name }} serta tips
                        dari
